...
#Region "FUNGSI UNTUK TABEL JENIS BUKU (tbjenis)"
    ...
    Public Function GetAllJenis() As DataTable
        ...
        Catch ex As Exception
            MessageBox.Show("Gagal menampilkan data jenis: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
        Return dt
    End Function
    ...
    Public Function SearchJenis(keyword As String) As DataTable
        ...
        Try
            ...
            End Using
        Catch ex As Exception
            MessageBox.Show("Gagal mencari data jenis: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
        Return dt
    End Function
    ...
    Public Function SimpanJenis(kode As String, namaJenis As String) As Boolean
        Try
            ...
            Return True
        Catch ex As Exception
            MessageBox.Show("Gagal menyimpan data jenis: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        End Try
    End Function
    ...
    Public Function UbahJenis(kode As String, namaJenis As String) As Boolean
        Try
            ...
            End Using
        Catch ex As Exception
            MessageBox.Show("Gagal mengubah data jenis: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        End Try
    End Function
    ...
    Public Function HapusJenis(kode As String) As Boolean
        Try
            ...
            End Using
        Catch ex As Exception
            MessageBox.Show("Gagal menghapus data jenis: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        End Try
    End Function
...
#Region "FUNGSI UNTUK TABEL BUKU (tbbuku)"
    ...
    Public Function SearchBuku(keyword As String) As DataTable
        ...
        Try
            Dim query As String = "SELECT tbbuku.kodeBuku, tbjenis.jenis AS 'Jenis Buku', " &
                                  ...
                                  "FROM tbbuku " &
                                  "INNER JOIN tbjenis ON tbbuku.kodeJenis = tbjenis.kodeJenis " &
                                  "WHERE tbbuku.judul LIKE @keyword OR tbbuku.penerbit LIKE @keyword " &
                                  "ORDER BY tbbuku.kodeBuku ASC"
            Using conn As MySqlConnection = GetConnection()
                Using da As New MySqlDataAdapter(query, conn)
                    da.SelectCommand.Parameters.AddWithValue("@keyword", "%" & keyword & "%")
    ...
    Public Function GetBukuByKode(kode As String) As DataTable
        Dim dt As New DataTable()
        Try
            Dim query As String = "SELECT * FROM tbbuku WHERE kodeBuku = @kodeBuku"
            Using conn As MySqlConnection = GetConnection()
                Using da As New MySqlDataAdapter(query, conn)
                    da.SelectCommand.Parameters.AddWithValue("@kodeBuku", kode)
                    da.Fill(dt)
                End Using
            End Using
        Catch ex As Exception
