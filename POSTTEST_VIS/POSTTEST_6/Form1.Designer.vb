...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        DataGridViewCellStyle4.BackColor = Color.FromArgb(CByte(22), CByte(38), CByte(16))
        dgvTanaman.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle4
        ...
        DataGridViewCellStyle5.BackColor = Color.FromArgb(CByte(26), CByte(74), CByte(15))
        ...
        dgvTanaman.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle5
        ...
        DataGridViewCellStyle6.BackColor = Color.FromArgb(CByte(18), CByte(30), CByte(14))
        DataGridViewCellStyle6.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        DataGridViewCellStyle6.ForeColor = Color.FromArgb(CByte(200), CByte(230), CByte(196))
        DataGridViewCellStyle6.Padding = New Padding(4, 0, 4, 0)
        DataGridViewCellStyle6.SelectionBackColor = Color.FromArgb(CByte(40), CByte(100), CByte(30))
        DataGridViewCellStyle6.SelectionForeColor = Color.White
        DataGridViewCellStyle6.WrapMode = DataGridViewTriState.False
        dgvTanaman.DefaultCellStyle = DataGridViewCellStyle6
        ...
        colJenis.DataPropertyName = "namaJenis"
